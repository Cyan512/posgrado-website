        ...
        <div className="space-y-3">
          <div className='flex items-center gap-3'>
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">
              <span className="font-semibold text-gray-900 dark:text-gray-100">Inscripciones hasta:</span> {time_end}
            </span>
          </div>
          ...
          <div className='flex items-center gap-3'>
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">
              <span className="font-semibold text-gray-900 dark:text-gray-100">Modalidad:</span> {mode}
            </span>
          </div>
        </div>
      </CardHeader>
